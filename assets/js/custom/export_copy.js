...
headerSectionForOthers.find('.header-section-area').remove();
...
let headerHTML = (fileName === "index") ? headerHTMLForIndex : headerHTMLForOthers;
let footerHTML = footerSection.html();
	...
	<link rel="stylesheet"
        ...
        <body class="${selectedThemeClass}">
            <div id="wrapper">
<div id="header">${fileName === "index" ? headerHTMLForIndex : headerHTMLForOthers}</div>
