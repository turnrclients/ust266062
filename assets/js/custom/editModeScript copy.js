    ...
    const modalHtml = `
        <div class="modal fade" id="dynamicModal" tabindex="-1" aria-labelledby="dynamicModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
				...
				<div id="home-25" class="component lazy-load-placeholder" category="Music & Performing Arts"></div>
				<div id="home-26" class="component lazy-load-placeholder" category="Music & Performing Arts"></div>
				...
				<div id="about-18" class="component lazy-load-placeholder" category="Music & Performing Arts"></div>
				...
				<div id="services-8" class="component lazy-load-placeholder" category="Music & Performing Arts"></div>
				...
				<div id="newsletter-4" class="component lazy-load-placeholder" category="Music & Performing Arts"></div>
